...
function setup() {
 createCanvas(windowWidth,windowHeight);
  ...
  invground=createSprite(50,750,600,10);
  invground.visible=false;
  
  alien=createSprite(50,750,20,20);
...
function draw() {
 background(0);
  ...
  if(keyDown("space") && alien.y===672.1){
    alien.velocityY=-18;
  }
    if(keyDown("space") && alien.y===671.5){
    alien.velocityY=-18;
  }
...
function spawnObstacles(){
  if(frameCount % 150===0){
    obstacle=createSprite(1500,700,20,20);
